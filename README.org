...
- The plot shows the combined frequency response of all bands. Drag a point
  on the curve up or down to adjust that band — the slider below follows,
  and the gain value is shown while you drag.
