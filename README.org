...
- *Six built-in profiles* — switch instantly, without clicks or dropouts:
  | Profile             | Character                                    |
  |---------------------+----------------------------------------------|
  | Flat                | No change; reference                         |
  | Bass Boost          | Fuller low end                               |
  | Treble Boost        | More air and sparkle                         |
  | V-Shaped            | Emphasized bass and treble                   |
  | Voice / Podcast     | Mid-range clarity for speech                 |
  | Classical / Neutral | Gentle, wide-band shaping                    |
- *Seven bands* — 60, 150, 400 Hz, 1, 2.5, 6, 12 kHz, each adjustable ±12 dB.
